 ...
 * @author w1740779
 */
public class LevelA1Interviewarrangements extends javax.swing.JFrame {
...
final String InterviewA = "-- A: Hi Derreck. How was your weekend?\n" +
"- B: ...\n" +
...
"- B: Thank you! I will **let you know** how it goes." ;
    ...
    public LevelA1Interviewarrangements() {
        initComponents();
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Interview arrangements");
        ...
        jCheckBox_Use.setText("Admin role");
        ...
        jCheckBox_Use1.setText("Dress code");
        jPanel1.add(jCheckBox_Use1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, 160, -1));

        jCheckBox_Use2.setText("Smart-casual");
        jPanel1.add(jCheckBox_Use2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 440, 160, -1));

        jCheckBox_Use4.setText("Secure a job interview");
        jPanel1.add(jCheckBox_Use4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, 160, -1));

        jCheckBox_Use3.setText("Let you know");
        jPanel1.add(jCheckBox_Use3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 600, 160, -1));

        jCheckBox_Use5.setText("Only 3 stops to the no. 32 bus");
        jPanel1.add(jCheckBox_Use5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 560, 180, -1));

        jCheckBox_Use6.setText("Online");
        jPanel1.add(jCheckBox_Use6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 520, 160, -1));

        jCheckBox_Use7.setText("Face-to-face");
        jPanel1.add(jCheckBox_Use7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 480, 160, -1));
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(InterviewA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(InterviewB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA1Interviewarrangements .class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA1Interviewarrangements ().setVisible(true);
            }
        });
    }
