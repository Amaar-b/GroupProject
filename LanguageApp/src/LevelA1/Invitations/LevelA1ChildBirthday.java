 ...
 */
package LevelA1.Invitations;

import LevelA1.Employment.*;
...
final String ChildBirthdayA = "- A: Hi Mary did you get my letter?\n" +
"- B: ...\n" +
"- A: Yes that one.\n" +
"- B: ...\n" +
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Help with child’s birthday party");
        ...
        jCheckBox_Use4.setText("Setting up");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(ChildBirthdayA);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA1ChildBirthday.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA1ChildBirthday().setVisible(true);
            }
        });
    }
