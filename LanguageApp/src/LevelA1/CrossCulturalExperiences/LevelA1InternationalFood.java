 ...
 */
package LevelA1.CrossCulturalExperiences;
...
final String InternationalFoodA = "- A: What is this?\n" +
"- B: ...\n" +
"- A: What kind of tea?\n" +
"- B: ...\n" +
...
final String InternationalFoodB ="- A: ...\n" +
"- B: It's tea.\n" +
"- A: ...\n" +
...
"- A: ..." ;
    ...
    public LevelA1InternationalFood() {
        initComponents();
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("International food");
        ...
        jCheckBox_Use4.setText("Spices");
        jPanel1.add(jCheckBox_Use4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, 160, -1));

        jCheckBox_Use3.setText("Text");
        jPanel1.add(jCheckBox_Use3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, 160, -1));

        jCheckBox_Use5.setText("Boil");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(InternationalFoodA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(InternationalFoodB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA1InternationalFood .class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA1InternationalFood ().setVisible(true);
            }
        });
    }
