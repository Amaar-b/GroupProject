 ...
 */
public class LevelA1Cover extends javax.swing.JFrame {
    
    /**
     * Creates new form w1740779
     */

    
final String CoverA = "- A: Hello, is the **manager** there?\n" +
"- B: ...\n" +
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jCheckBox_Use.setText("To call back");
        ...
        jCheckBox_Use1.setText("To take a message");
        jPanel1.add(jCheckBox_Use1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, 160, -1));

        jCheckBox_Use2.setText("Shift");
        jPanel1.add(jCheckBox_Use2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 560, 160, -1));

        jCheckBox_Use4.setText("Manager");
        jPanel1.add(jCheckBox_Use4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, 160, -1));

        jCheckBox_Use3.setText("I’ve got a cold");
        jPanel1.add(jCheckBox_Use3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 440, 160, -1));

        jCheckBox_Use5.setText("Find cover");
        jPanel1.add(jCheckBox_Use5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 480, 160, -1));

        jCheckBox_Use6.setText("Send a message in the group chat");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(CoverA);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA1Cover.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA1Cover().setVisible(true);
            }
        });
    }
