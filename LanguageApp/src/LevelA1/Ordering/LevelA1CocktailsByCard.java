 ...
 * @author w1776316
 */
public class LevelA1CocktailsByCard extends javax.swing.JFrame {
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA1CocktailsByCard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA1CocktailsByCard().setVisible(true);
            }
        });
    }
