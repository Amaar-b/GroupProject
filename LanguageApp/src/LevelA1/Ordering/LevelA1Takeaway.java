 ...
 * @author w1776316
 */
public class LevelA1Takeaway extends javax.swing.JFrame {
    
    /**
     * Creates new form profilePage
     */

    public LevelA1Takeaway() {
        initComponents();
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jCheckBox_Reservation = new javax.swing.JCheckBox();
        jCheckBox_Wait = new javax.swing.JCheckBox();
        jCheckBox_About = new javax.swing.JCheckBox();
        jCheckBox_Takeaway = new javax.swing.JCheckBox();
        ...
        jLabel5.setText("Present simple: do you have?");
        ...
        jCheckBox_Reservation.setText("Reservation");
        jPanel1.add(jCheckBox_Reservation, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, 160, -1));

        jCheckBox_Wait.setText("Wait");
        jPanel1.add(jCheckBox_Wait, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 360, 160, -1));

        jCheckBox_About.setText("About");
        jPanel1.add(jCheckBox_About, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, 160, -1));

        jCheckBox_Takeaway.setText("Takeaway");
        jCheckBox_Takeaway.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCheckBox_TakeawayActionPerformed(evt);
            }
        });
        jPanel1.add(jCheckBox_Takeaway, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 440, 160, -1));
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea("- A: Hi there. Do you have a table for 2?\n" +
"- B: ...\n" +
"- A: I’m sorry I don’t\n" +
"- B: ...\n" +
"- A: How long is the **wait** for the table? I am very hungry\n" +
"- B: ...\n" +
"- A: Yes please. I will have two burgers and two portions of fries. Oh and two large drinks. Thank you very much.\n" +
...
"- A: You too");
    ...
    private void jCheckBox_TakeawayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox_TakeawayActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jCheckBox_TakeawayActionPerformed
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea("\"- B: Good evening. Do you have a **reservation** with us?\\n\" +\n" +
"\"- A: ...\\n\" +\n" +
"\"- B: I’m afraid we’re very busy tonight so there are no free tables. Would you like to wait or come back later?\\n\" +\n" +
"\"- A: ...\\n\" +\n" +
"\"- B: It is **about** one hour. I’m sorry about that. Would you like to order your food for **takeaway** instead?\\n\" +\n" +
"\"- A: ...\\n\" +\n" +
"\"- B: No problem. Your food should be there soon. Have a nice evening!\\n\" +\n" +
"\"- A: ...\");");
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA1Takeaway.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA1Takeaway().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JCheckBox jCheckBox_About;
    private javax.swing.JCheckBox jCheckBox_Reservation;
    private javax.swing.JCheckBox jCheckBox_Takeaway;
    private javax.swing.JCheckBox jCheckBox_Wait;
