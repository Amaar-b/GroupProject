 ...
 */
public class LevelA1DescriptionOfTown extends javax.swing.JFrame {
...
final String DescriptionA = "- A: Hi, my name is Claire.\n" +
"- B: ...\n" +
"- A: Nice to meet you too, where are you from?\n" +
"- B: ...\n" +
"- A: I'm from Cardigan.\n" +
"- B: ...\n" +
"- A: It's a small town in the north of Wales.\n" +
"- B: ...\n" +
"- A: It is a town **close to the beach**. It's also got a lovely river. You should visit sometime.\n" +
"- B: ...\n" +
"- A: Hm, there's an **ancient** castle, they have **festivals** there in the summertime. There is also a market, a museum and a theatre.\n" +
"- B: ...";
            
final String DescriptionB ="- A: ...\n" +
"- B: Nice to meet you, I'm Robert.\n" +
"- A: ...\n" +
"- B: I'm from London, how about you?\n" +
"- A: ...\n" +
"- B: Oh, where is that? I've never heard of it.\n" +
"- A: ...\n" +
"- B: What is it like?\n" +
"- A: ...\n" +
"- B: I don't like going to the beach because I don't like sand. Is there anything else there to see?\n" +
"- A: ...\n" +
"- B: That does sound like a nice place, maybe I will visit sometime" ;
    
    
    public LevelA1DescriptionOfTown() {
        initComponents();
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Description of town");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(DescriptionA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(DescriptionB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA1DescriptionOfTown.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA1DescriptionOfTown().setVisible(true);
            }
        });
    }
