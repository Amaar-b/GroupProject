 ...
 */
package LevelA1.UniversityLife;
 ...
 * @author w1776316
 */
public class LevelA1CafeStudy extends javax.swing.JFrame {
...
final String CafeStudyA = "- A: Hey, good to see you.\n" +
"- B: ...\n" +
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(CafeStudyA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(CafeStudyB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA1CafeStudy .class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA1CafeStudy ().setVisible(true);
            }
        });
    }
