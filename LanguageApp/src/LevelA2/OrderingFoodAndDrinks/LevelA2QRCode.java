 ...
 * @author hari
 */
public class LevelA2QRCode extends javax.swing.JFrame {
...
final String QRCodeA = "- A: Good morning, can I get a large almond milk latte please?\n" +
"- B: ...\n" +
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jCheckBox_Use6.setText("Oat");
        jPanel1.add(jCheckBox_Use6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 360, 160, -1));

        jCheckBox_Use7.setText("Soya");
        jPanel1.add(jCheckBox_Use7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 400, 160, -1));

        jCheckBox_Use8.setText("Scan");
        jPanel1.add(jCheckBox_Use8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 520, 160, -1));

        jCheckBox_Use9.setText("Peppermint");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(QRCodeA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(QRCodeB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA2QRCode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA2QRCode().setVisible(true);
            }
        });
    }
