 ...
 * @author hari
 */
public class LevelA2DelayedDrinksOrder extends javax.swing.JFrame {
...
final String DelayedDrinksOrderA = "- A: - Excuse me, where is my coffee. I've been waiting over 20 minutes.\n" +
"-\n" +
"- B: ...\n" +
...
final String DelayedDrinksOrderB ="- A: ...\n" +
...
"- A: ...\n" ;
    ...
    public LevelA2DelayedDrinksOrder() {
        initComponents();
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Delayed drinks order");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(DelayedDrinksOrderA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(DelayedDrinksOrderB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA2DelayedDrinksOrder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA2DelayedDrinksOrder().setVisible(true);
            }
        });
    }
