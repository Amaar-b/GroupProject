 ...
 * @author hari
 */
public class LevelA2Doctor extends javax.swing.JFrame {
...
final String DoctorA = "- A: Good Morning, I'd like to make an appointment with Dr Tiberal.\n" +
"- B: ...\n" +
"- A: 27th of June 1989\n" +
"- B: ...\n" +
"- A: It's Jane Brown.\n" +
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(DoctorA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(DoctorB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA2Doctor .class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA2Doctor ().setVisible(true);
            }
        });
    }
