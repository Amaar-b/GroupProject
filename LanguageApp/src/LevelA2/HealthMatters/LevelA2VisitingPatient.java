 ...
 * @author hari
 */
public class LevelA2VisitingPatient extends javax.swing.JFrame {
...
final String VisitingPatientA = "- A: Hi there I'm here to see Mr. Smith.\n" +
"- B: ...\n" +
...
final String VisitingPatientB ="- A: ...\n" +
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Visiting Patient");
        ...
        jCheckBox_Use5.setText("Making his rounds");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(VisitingPatientA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(VisitingPatientB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA2VisitingPatient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA2VisitingPatient().setVisible(true);
            }
        });
    }
