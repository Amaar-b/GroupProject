 ...
 * @author hari
 */
public class LevelA2Lunch extends javax.swing.JFrame {
...
final String LunchA = "- A: Do you want to go for lunch at the weekend?\n" +
"- B: ...\n" +
...
final String LunchB ="- A: ...\n" +
"- I'm afraid not, I work on weekends.\n" +
"- A: ...\n" +
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(LunchA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(LunchB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA2Lunch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA2Lunch().setVisible(true);
            }
        });
    }
