 ...
 */
package LevelA2.MakingInvitations;
 ...
 * @author hari
 */
public class LevelA2ChildrenAtWedding extends javax.swing.JFrame {
...
final String ChildrenAtWeddingA = "- A: Hey Bill, did you get my wedding invitation?\n" +
"- B: ...\n" +
"- A: I didn't receive your RSVP yet.\n" +
"- B: ...\n" +
"- A: So sorry to hear that, hopefully we can all get together another time.\n" +
"- B: ...\n" +
"- A: That's okay. Have a good one!\n" +
"- B: ..." ;
            
final String ChildrenAtWeddingB ="- A: ...\n" +
"- B: I did, yes.\n" +
"- A: ...\n" +
"- B: Unfortunately, we won't be able to come, the invitation said that it's adults only but there won't be anyone to look after our daughter.\n" +
"- A: ...\n" +
"- B: Congratulations and thank you for inviting us anyway.\n" +
"- A: ...\n" +
"- B: You too.";
    
    
    public LevelA2ChildrenAtWedding() {
        initComponents();
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("ChildrenAtWedding");
        ...
        jCheckBox_Use5.setText("Wedding");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(ChildrenAtWeddingA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(ChildrenAtWeddingB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA2ChildrenAtWedding.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA2ChildrenAtWedding().setVisible(true);
            }
        });
    }
