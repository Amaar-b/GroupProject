 ...
 * @author w1740779
 */
public class LevelA2JobOffer extends javax.swing.JFrame {
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jCheckBox_Use5.setText("Following");
        ...
        jCheckBox_Use6.setText("Position");
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA2JobOffer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA2JobOffer().setVisible(true);
            }
        });
    }
