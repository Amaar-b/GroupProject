 ...
 */
package LevelA2.CrossCulturalExperiences;
 ...
 * @author hari
 */
public class LevelA2Omelette extends javax.swing.JFrame {
...
final String OmeletteA = "- A: What is this?\n" +
"- B: ...\n" +
...
"- B: ..." +
"- A: Excellent, is it recyclable?" +
"- B: ...";
            
final String OmeletteB ="- A: ...\n" +
"- B: It's a Tortilla.\n" +
"- A: ...\n" +
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jCheckBox_Use6.setText("Takeaway Box");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(OmeletteA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(OmeletteB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA2Omelette.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA2Omelette().setVisible(true);
            }
        });
    }
