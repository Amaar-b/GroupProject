 ...
 */
package LevelA2.ExchangingPersonalInformations;
 ...
 * @author hari
 */
public class LevelA2AgeRestricted extends javax.swing.JFrame {
...
final String AgeRestrictedA = "- A: Hi there, I have a package for Ms. Anna Smith?\n" +
"- B: ...\n" +
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Age Restricted");
        ...
        jCheckBox_Use5.setText("Age Restricted");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(AgeRestrictedA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(AgeRestrictedB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelA2AgeRestricted.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelA2AgeRestricted().setVisible(true);
            }
        });
    }
