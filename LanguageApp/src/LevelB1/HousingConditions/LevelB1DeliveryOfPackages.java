 ...
 */
package LevelB1.HousingConditions;
 ...
 * @author hari
 */
public class LevelB1DeliveryOfPackages extends javax.swing.JFrame {
...
final String DeliveryOfPackagesA = "- A: Hello? who is it?\n" +
"- B: ...\n" +
"- A: Is there something wrong?\n" +
"- B: ...\n" +
"- A: I'm not expecting anything.\n" +
"- B: ...\n" +
"- A: This package hasn't arrived.\n" +
"- B: ..." +
"- A: I hope you find it in the future." +
"- B: ...";
            
final String DeliveryOfPackagesB ="- A: ...\n" +
"- B: It's mark from down the road.\n" +
"- A: ...\n" +
"- B: My package was said to be delivered but it hasn't arrived\n" +
"- A: ...\n" +
"- B: The picture shows you holding the package\n" +
"- A: ...\n" +
"- B: This may have been a misunderstanding" +
"- A: ...\n" +
"- B: Bye-Bye";
    
    
    public LevelB1DeliveryOfPackages() {
        initComponents();
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Delivery Of Packages");
        ...
        jCheckBox_Use5.setText("At least");
        ...
        jCheckBox_Use6.setText("Careful");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(DeliveryOfPackagesA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(DeliveryOfPackagesB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelB1DeliveryOfPackages.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelB1DeliveryOfPackages().setVisible(true);
            }
        });
    }
