 ...
 */
package LevelB1.BasicEmploymentIssues;
 ...
 * @author hari
 */
public class LevelB1JobOffers extends javax.swing.JFrame {
...
final String JobOfferA = "- A: Good morning, am I speaking to Lucy?\n" +
"- B: ...\n" +
...
"- B: ..."+
"- A: If you have an insurance card bring that along too. There's no uniform but dress smartly. Blazer, black trousers, basic office attire." +            
"- B: ..."+
"- A: My pleasure Lucy, welcome to the team. Bye!" ;      
final String JobOfferB ="- A: ...\n" +
"- B: Hi, yes that's me.\n" +
"- A: ...\n" +
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Basic Employment Issues");
        ...
        jCheckBox_Use4.setText("Attire");
        jPanel1.add(jCheckBox_Use4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 510, 160, -1));

        jCheckBox_Use5.setText("Notice");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(JobOfferA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(JobOfferB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelB1JobOffers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelB1JobOffers().setVisible(true);
            }
        });
    }
