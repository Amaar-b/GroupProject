 ...
 */
package LevelB1.OrderingFoodAndDrink;
 ...
 * @author hari
 */
public class LevelB1OrderingCocktailsByBarcode extends javax.swing.JFrame {
...
final String OrderingCocktailsByBarcodeA = "- A: Hi there, can we order some cocktails please?\n" +
"- B: ...\n" +
...
final String OrderingCocktailsByBarcodeB ="- A: ...\n" +
...
"- A: ...\n" ;
    ...
    public LevelB1OrderingCocktailsByBarcode() {
        initComponents();
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("OrderingFoodAndDrink");
        ...
        jCheckBox_Use4.setText("Policy");
        jPanel1.add(jCheckBox_Use4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 430, 160, -1));

        jCheckBox_Use5.setText("Scan the barcode");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(OrderingCocktailsByBarcodeA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(OrderingCocktailsByBarcodeB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelB1OrderingCocktailsByBarcode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelB1OrderingCocktailsByBarcode().setVisible(true);
            }
        });
    }
