 ...
 * @author hari
 */
public class LeveB1CancelHairAppointment extends javax.swing.JFrame {
...
final String CancelHairAppointmentA = "- A: Good morning, how can I help?\n" +
"- B: ...\n" +
...
final String CancelHairAppointmentB ="- A: ...\n" +
...
"- B: Well, I will not be coming back here again.";
    ...
    public LeveB1CancelHairAppointment() {
        initComponents();
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Cancel Hair Appointment");
        ...
        jCheckBox_Use4.setText("Last minute");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(CancelHairAppointmentA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(CancelHairAppointmentB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LeveB1CancelHairAppointment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LeveB1CancelHairAppointment().setVisible(true);
            }
        });
    }
