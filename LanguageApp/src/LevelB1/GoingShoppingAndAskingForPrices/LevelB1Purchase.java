 ...
 * @author hari
 */
public class LevelB1Purchase extends javax.swing.JFrame {
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jCheckBox_Use4.setText("Authoriised");
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelB1Purchase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelB1Purchase().setVisible(true);
            }
        });
    }
