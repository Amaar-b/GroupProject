 ...
 */
package LevelB1.SocialisingInTheCountry;
 ...
 * @author hari
 */
public class LevelB1Haircut extends javax.swing.JFrame {
...
final String HaircutA = "- A: Hiya, long time no see!\n" +
"- B: ...\n" +
...
"- A: ...\n" +
"- B: I had a cut and blow dry and a full head of colour so it was £200." +
"- A: ...\n" +
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jCheckBox_Use5.setText("Blowdry");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(HaircutA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(HaircutB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelB1Haircut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelB1Haircut().setVisible(true);
            }
        });
    }
