 ...
 */
package LevelB2.BasicEmploymentIssues;
 ...
 * @author hari
 */
public class LevelB2MeetForDrinks extends javax.swing.JFrame {
...
final String MeetForDrinksA = "- A: Hi I haven't seen you around, are you new?\n" +
"- B: ...\n" +
...
final String MeetForDrinksB ="- A: ...\n" +
"- B: Hi, yeah I am! Yesterday was my first day.\n" +
"- A: ...\n" +
"- B: Pretty good. Everyone is really nice and the workload is manageable.\n" +
"- A: ...\n" +
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Meet For Drinks");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(MeetForDrinksA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(MeetForDrinksB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelB2MeetForDrinks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelB2MeetForDrinks().setVisible(true);
            }
        });
    }
