 ...
 */
package LevelB2.SocialisingInTheCountry;
 ...
 * @author hari
 */
public class LevelB2NoShowDate extends javax.swing.JFrame {
...
final String NoShowDateA = "- A: Hi Peter. How was your weekend?\n" +
"- B: ...\n" +
"- A: What happened?\n" +
"- B: ...\n" +
"- A: That's awful.\n" +
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(NoShowDateA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(NoShowDateB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelB2NoShowDate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelB2NoShowDate().setVisible(true);
            }
        });
    }
