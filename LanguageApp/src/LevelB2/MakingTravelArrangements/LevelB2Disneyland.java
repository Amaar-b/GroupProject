 ...
 */
package LevelB2.MakingTravelArrangements;
 ...
 * @author hari
 */
public class LevelB2Disneyland extends javax.swing.JFrame {
...
final String DisneylandA = "- A: Hi John did you get my letter?\n" +
"- B: ...\n" +
"- A: Yeah that one.\n" +
"- B: ...\n" +
...
"- A: ...\n" +
"- B: We did! Kids under the age of 8 get free entry and we're staying in an Airbnb so we're saving a lot on food and accommodation too.\n" +
"- A: ...\n" +
"- B: No need for parking, the Airbnb is actually only a 15 minute walk from the park!" +
"- A: ...\n" ;
    
    
    public LevelB2Disneyland() {
        initComponents();
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jCheckBox_Use4.setText("Resort");
        jPanel1.add(jCheckBox_Use4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 440, 160, -1));

        jCheckBox_Use5.setText("Airbnb");
        ...
        jCheckBox_Use6.setText("Accommodation");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(DisneylandA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(DisneylandB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelB2Disneyland.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelB2Disneyland().setVisible(true);
            }
        });
    }
