 ...
 */
package LevelB2.GoingShoppingAndAskingForPrices;
 ...
 * @author hari
 */
public class LevelB2PhonePurchase extends javax.swing.JFrame {
...
final String PhonePurchaseA = "- A: Hi, can I buy this phone?\n" +
"- B: ...\n" +
"- A: No, I didn't.\n" +
"- B: ...\n" +
...
//        jComboBox_Context.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Phone Purchase");
    ...
    private void jButton_PersonAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonAActionPerformed
       ...
       JFrame frame = new JFrame("StudentA");  
        ...
        JTextArea textArea = new JTextArea(PhonePurchaseA);
    ...
    private void jButton_PersonBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PersonBActionPerformed
        ...
        JTextArea textArea = new JTextArea(PhonePurchaseB);
...
//        panel2.add(button);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelB2PhonePurchase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelB2PhonePurchase().setVisible(true);
            }
        });
    }
